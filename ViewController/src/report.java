...
public class report {
    ...
    private void printAttributeForOtherCOst(int detailNumOfCol, int xlCol) {
        int dataxlCol= xlCol;
           ...
           //   System.out.println("------------------------------ xlRow   " +xlRow);
...
//        System.out.println("==============================  (avdry/totalQuantity)+(avwet/totalQuantity)   " + (avdry/totalQuantity)+(avwet/totalQuantity)  );
//        System.out.println("==============================  avgWashCost  " + avgWashCost/totalQuantity );
                  
        //        System.out.println("totalQuantity "+totalQuantity);
        //        System.out.println("avfob "+avfob);
        //        System.out.println("avprofit "+avprofit);
        //        System.out.println("avcm "+avcm);
        //        System.out.println("avdry "+avdry);
        //        System.out.println("avwet "+avwet);
               
                   String[] Array = {"AVG FOB", "AVG N/P", "AVG CM", "DRY AVG", "WET AVG", "TTL WASH AVG"};
               for(int i=0;i<6;i++) {
                   try {
                        System.out.println(dataxlCol);
